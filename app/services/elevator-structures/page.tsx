    ...
    <main className="about-page-enter min-h-screen bg-white">
      ...
      >
        ...
        <div className="about-hero-content relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-wide text-white text-center">
            Asansör Bölme Çelikleri ve Taşıyıcıları
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/90 sm:text-lg">
            Asansör kuyusu için gerekli çelik taşıyıcı sistemleri, ara kat bağlantıları
            ve cam/kompozit kaplama taşıyıcılarını projelendirip uyguluyoruz.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-gray-700">
            ...
            çelik asansör kulelerinin imalatı için statik hesap, detay çizimi ve sahada
            montaj süreçlerini üstleniyoruz. Asansör firmalarıyla koordineli çalışarak
            güvenli ve yönetmeliklere uygun çözümler üretiyoruz.
          </p>
        </div>
      </section>
    </main>
