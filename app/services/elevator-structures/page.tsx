...
export default function ElevatorStructuresPage() {
  const data = getServicePageData("elevator-structures");
            ...
            <div>
              ...
              <section className="mt-12">
                ...
                <p className="mt-4 text-base leading-relaxed text-gray-700">
                  Asansör çelik konstrüksiyon projelerimizden bazı örnekler. Tüm projelerimizi ve detaylarını incelemek için{" "}
                  <Link
                    href="/projects"
