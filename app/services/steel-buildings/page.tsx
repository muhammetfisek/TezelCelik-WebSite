      ...
      >
        ...
        <div className="about-hero-content relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/90 sm:text-lg">
            Endüstriyel tesisler, depolar ve ticari yapılar için çelik bina çözümleri;
            hızlı kurulum, yüksek dayanım ve esnek mimari ile tasarlanır.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-gray-700">
            Çelik binalar; uzun açıklık gerektiren, yüksek taşıma kapasitesi isteyen ve
            hızlı devreye alınması gereken projeler için en uygun yapı sistemlerinden
            biridir. Statik projelendirme, imalat ve montaj süreçlerinin tamamını
            mühendislik disipliniyle yönetiyor, sahada minimum duruşla yapınızı teslim
            ediyoruz.
          </p>
        </div>
      </section>
