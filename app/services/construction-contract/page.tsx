import { FaCheckCircle, FaHandshake, FaHardHat, FaFileContract } from "react-icons/fa";
...
export default function ConstructionContractPage() {
  return (
      ...
      >
        ...
        <div className="about-hero-content relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/90 sm:text-lg">
            Çelik konstrüksiyon ve inşaat işlerinde ana yüklenici veya alt
            yüklenici olarak taahhüt hizmeti. Proje yönetimi, şantiye organizasyonu
            ve zamanında teslimat.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-18">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-gray-700">
            Çelik yapıların projelendirilmesi, imalatı ve montajını tek elden veya
            mevcut inşaat projelerine entegre taahhüt ediyoruz. Keşif, planlama,
            tedarik ve sahada uygulama süreçlerini yönetiyoruz.
          </p>

          <ul className="mt-7 grid gap-3 text-gray-800 sm:grid-cols-1 lg:grid-cols-2">
            <li className="flex items-start gap-3">
              <FaFileContract className="mt-0.5 shrink-0 text-[#FF5A3C]" />
              <span>
                <strong>Keşif ve teklif</strong> – Proje incelemesi, maliyet
                analizi ve sözleşme süreçleri.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <FaHardHat className="mt-0.5 shrink-0 text-[#FF5A3C]" />
              <span>
                <strong>Şantiye yönetimi</strong> – Planlama, iş programı ve
                koordinasyon.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <FaHandshake className="mt-0.5 shrink-0 text-[#FF5A3C]" />
              <span>
                <strong>Teslimat ve devir</strong> – Zamanında teslim ve
                dokümantasyon.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Kalite ve güvence</strong> – Standartlara uygunluk ve
                garanti süreçleri.
              </span>
            </li>
          </ul>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <span className="about-badge">Ana Yüklenici</span>
            <span className="about-badge">Alt Yüklenici</span>
            <span className="about-badge">Proje Yönetimi</span>
            <span className="about-badge">Şantiye Organizasyonu</span>
          </div>
        </div>
      </section>
    </main>
