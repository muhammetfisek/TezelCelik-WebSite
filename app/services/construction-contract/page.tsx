...
const SERVICE_ID = "construction-contract" as const;

const ORNEK_PROJELER = [
  { title: "İnşaat Taahhüt Projesi", image: insaatTaahhutImg },
  { title: "Çelik Konstrüksiyon Taahhüt", image: celikKonstruksiyonImg },
  { title: "Yapı Güvenliği ve Taahhüt", image: nervurDemirImg },
];
      ...
      <section className="bg-gray-50 py-14 sm:py-18">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-gray-700">
            İnşaat taahhüt kapsamında tamamladığımız projelerden örnekler. Tüm projeleri incelemek için{" "}
            <Link
              href="/projects"
