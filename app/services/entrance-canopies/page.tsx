    ...
    <main className="about-page-enter min-h-screen bg-white">
      ...
      >
        ...
        <div className="about-hero-content relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center">
          ...
          Yapınıza değer katan; modern tasarımlı, yüksek dayanımlı çelik giriş saçağı ve kanopi çözümleri.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-6 lg:gap-8 lg:grid-cols-[minmax(0,2.1fr)_minmax(0,0.9fr)]">
            <div>
              ...
              <p className="mt-6 text-base leading-relaxed text-gray-700">
                ...
                seçenekleri sunuyoruz. Her projede bina kimliğini güçlendiren, işlevsel
                ve zarif çözümler hedefliyoruz.
              </p>
              ...
              <section className="mt-12">
                ...
                <p className="mt-4 text-base leading-relaxed text-gray-700">
                  Giriş saçağı ve kanopi projelerimizden bazı örnekler:
                </p>
              ...
              <section className="mt-14">
                ...
                <p className="mt-4 max-w-3xl text-base leading-relaxed text-gray-700">
                  Kanopi ve saçak sistemlerinde; mimari beklentiyi, taşıyıcı güvenliği ve
                  detay çözümünü birlikte ele alıyoruz.
                </p>
                <ul className="mt-6 max-w-3xl list-disc space-y-3 pl-5 text-base leading-relaxed text-gray-700">
                  <li>
                    İnce kesitli çelik profillerle hafif ama yüksek taşıma kapasiteli
                    tasarımlar
                  </li>
                  <li>
                    Kar ve rüzgâr yükleri için hesaplanmış, yönetmeliklere uygun statik
                    çözümler
                  </li>
                  <li>
                    Cam, kompozit ve polikarbon kaplamalarla uyumlu alt konstrüksiyon
                    detayları
                  </li>
                  <li>
                    Gizli dere ve yağmur suyu tahliye çözümleriyle cepheyi koruyan
                    uygulamalar
                  </li>
                  <li>
                    Hızlı montaj ve kullanım sırasında minimum müdahale gerektiren dayanıklı
                    yüzey kaplamaları
                  </li>
                </ul>
              </section>
