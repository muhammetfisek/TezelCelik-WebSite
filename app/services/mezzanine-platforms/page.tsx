            ...
            <div>
              ...
              <section className="mt-12">
                ...
                <p className="mt-4 text-base leading-relaxed text-gray-700">
                  Arakat ve platform projelerimizden bazı örnekler. Tüm projelerimizi ve detaylarını incelemek için{" "}
                  <Link
                    href="/projects"
              ...
              <RelatedBlogsSection serviceId={"mezzanine-platforms"} />
            </div>
            <ServicesSidebar currentHref="/services/mezzanine-platforms" />
          </div>
        </div>
      </section>
      <ServicesCtaBanner />
