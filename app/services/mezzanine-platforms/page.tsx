...
export const metadata: Metadata = {
  title: "Arakat ve Platformlar | Tezel Çelik",
  description:
    "Depo ve üretim alanlarında ilave kullanım alanı sağlayan çelik arakat ve platform çözümleri.",
  openGraph: {
    title: "Arakat ve Platformlar | Tezel Çelik",
    description:
      "Depo ve üretim alanlarında ilave kullanım alanı sağlayan çelik arakat ve platform çözümleri.",
      ...
      >
        ...
        <div className="about-hero-content relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/90 sm:text-lg">
            Mevcut binaların içine çelik taşıyıcılarla ilave kat ve çalışma platformları
            kurarak alan verimliliğinizi artırıyoruz.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-gray-700">
            Raf üstü platformlar, ofis arakatları, makine bakım platformları ve üretim
            hatları için özel çözümler geliştiriyoruz. Statik hesaplara uygun, güvenli
            ve sökülebilir sistemler ile esnek kullanım imkânı sağlıyoruz.
          </p>
        </div>
      </section>
    </main>
