      ...
      >
        ...
        <div className="about-hero-content relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/90 sm:text-lg">
            Yangın kaçış, servis ve mimari merdivenler için güvenli, yönetmeliklere
            uygun ve estetik çelik merdiven çözümleri sunuyoruz.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-gray-700">
            ...
            merdivenler için çelik taşıyıcı sistemler tasarlıyor, kaplama ve korkuluk
            detaylarını birlikte ele alıyoruz.
          </p>
        </div>
      </section>
    </main>
